              ...
              <div ref={resultsRef} className={`transition-all duration-1000 ease-in-out overflow-hidden ${estimatedValue !== null ? 'max-h-[2500px] opacity-100 mt-10 pt-8 border-t border-[#1A2333]' : 'max-h-0 opacity-0 m-0 p-0 border-transparent'}`}>
                ...
                <div className="flex flex-col items-center justify-center mb-8 gap-3 max-w-[320px] mx-auto">
                  ...
                  <button 
                    ...
                    className="flex items-center gap-3 bg-white text-slate-800 px-6 py-2.5 rounded-xl hover:bg-slate-100 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg font-semibold text-[15px] w-full justify-center border border-slate-200"
                  >
