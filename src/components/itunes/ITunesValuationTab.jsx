...
<div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
  ...
  <div className="relative group">
    ...
    <div className="absolute z-20 top-10 right-0 w-64 p-3 text-xs bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl
      ...
      <p className="font-bold mb-1 text-slate-900 dark:text-white">About Catalog Score</p>
      <p className="text-slate-600 dark:text-slate-400">
        Computed from countable metadata:{" "}
        <strong>(albums × 5) + (singles × 2) + (tracks × 1)</strong>,
        clamped to 100. A higher score means a deeper catalog and
        greater passive income potential.
      </p>
    </div>
  </div>
  ...
  <div className="relative group">
    ...
    <div className="absolute z-20 top-10 right-0 w-64 p-3 text-xs bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl
      opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
      <p className="font-bold mb-1 text-slate-900 dark:text-white">About this rate</p>
      <p className="text-slate-600 dark:text-slate-400">
        This is a blended global average (~$0.01 per stream).
        It is <strong>not geo-weighted</strong>. Actual payouts vary
        significantly by country, subscription tier, and label agreements.
      </p>
    </div>
  </div>
  ...
  <div className="relative group">
    ...
    <div className="absolute z-20 top-10 right-0 w-64 p-3 text-xs bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl
      opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
      <p className="font-bold mb-1 text-slate-900 dark:text-white">About Catalog Depth</p>
      <p className="text-slate-600 dark:text-slate-400">
        Shows total <strong>Albums (A)</strong> and{" "}
        <strong>Singles (S)</strong> released by this artist.
        More releases = more streams from back-catalog = higher
  ...
  <div className="relative group">
    ...
    <div className="absolute z-20 top-10 right-0 w-64 p-3 text-xs bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl
      opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
      <p className="font-bold mb-1 text-slate-900 dark:text-white">About Catalog Bonus</p>
      <p className="text-slate-600 dark:text-slate-400">
        A bonus of up to <strong>+50%</strong> added to LTM revenue
        based on release depth:{" "}
        <strong>(albums × 5%) + (singles × 1%)</strong>. Rewards
        artists with larger back-catalogs generating passive income.
      </p>
    </div>
  </div>
