  ...
  />
        ...
        <div className="flex justify-center my-8">
          <a
            ...
            className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#1DB954] hover:bg-[#1ed760] text-white text-base font-bold rounded-2xl shadow-xl hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto"
          >
            <LogIn size={20} />
            Login to your Spotify dashboard
          </a>
        </div>
