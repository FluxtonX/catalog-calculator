    ...
    <button
      ...
      className={`
        ...
        ${hasValidData && !isSaving
          ? "bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 hover:shadow-2xl hover:-translate-y-0.5 active:translate-y-0"
