...
const ValuationEstimates = ({ 
  conservativeValuation, minConservativeValuation, maxConservativeValuation,
  marketValuation, minMarketValuation, maxMarketValuation,
  premiumValuation, minPremiumValuation, maxPremiumValuation,
  formatCurrency 
}) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border-2 border-slate-200 dark:border-slate-800 shadow-xl p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <ValuationCard 
          icon={Shield} title="Conservative" multiple="6×" 
          value={minConservativeValuation ? formatRange(minConservativeValuation, maxConservativeValuation, formatCurrency) : formatCurrency(conservativeValuation)}
        ...
        />
        <ValuationCard 
          icon={TrendingUp} title="Market" multiple="8×" 
        ...
        />
        <ValuationCard 
          icon={Star} title="Premium" multiple="10×" 
          value={minPremiumValuation ? formatRange(minPremiumValuation, maxPremiumValuation, formatCurrency) : formatCurrency(premiumValuation)}
