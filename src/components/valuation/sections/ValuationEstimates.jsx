...
<SectionHeader icon={BarChart3} title="CFA Estimated Catalog Valuation" subtitle="Based on publicly available streaming data" gradient="from-emerald-500 to-emerald-600" />
    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
      <ValuationCard icon={Shield} title="Low Estimate" multiple="6×" value={formatCurrency(lowEstimate)}
        accent={{ border: "border-emerald-300 dark:border-emerald-500/30", bg: "bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/10", iconBg: "bg-gradient-to-br from-emerald-500 to-emerald-700", text: "text-emerald-600 dark:text-emerald-400", sep: "bg-emerald-300 dark:bg-emerald-500/50", ring: "", badge: "" }}
      />
