  ...
  <div className="bg-white dark:bg-slate-900 rounded-3xl border-2 border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
    ...
    <div className="p-5 sm:p-7">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        {/* Col 2: Streaming */}
        <div className="space-y-1">
          <h4 className="font-bold text-[#CC0000] dark:text-[#CC0000] text-xs sm:text-sm uppercase tracking-wide mb-3">
          ...
          <div className="flex justify-between items-center py-2.5 bg-[#CC0000]/10 dark:bg-[#CC0000]/20 rounded-xl px-3 mt-2">
            <span className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-300">Streaming Revenue</span>
            <span className="text-xs sm:text-sm font-black text-[#CC0000] dark:text-[#CC0000]">{formatCurrency(streamingRevenue)}</span>
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          {[
            { label: "Ad Revenue", value: formatCurrency(adRevenue), color: "text-[#CC0000] dark:text-[#CC0000]" },
            { label: "Streaming Revenue", value: formatCurrency(streamingRevenue), color: "text-[#CC0000] dark:text-[#CC0000]" },
          ].map((row) => (
            <div key={row.label} className="flex justify-between items-center py-2.5 border-b border-slate-100 dark:border-slate-800">
              <span className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">{row.label}</span>
          ...
          <div className="flex justify-between items-center py-2.5 bg-[#CC0000]/10 dark:bg-[#CC0000]/20 rounded-xl px-3 mt-2">
            ...
            <span className="text-xs sm:text-sm font-black text-[#CC0000] dark:text-[#CC0000]">{formatCurrency(totalAnnualRevenue)}</span>
          </div>
        </div>
      </div>

      {/* Info note */}
      <div className="mt-6 flex items-start gap-2.5 p-4 bg-[#CC0000]/5 dark:bg-[#CC0000]/20 border border-[#CC0000]/20 dark:border-[#CC0000]/30 rounded-xl">
        <Info size={15} className="text-[#CC0000] mt-0.5 flex-shrink-0" />
        <p className="text-xs sm:text-sm text-[#CC0000]/80 dark:text-[#CC0000]/90">
