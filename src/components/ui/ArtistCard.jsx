...
setEnhancedAlbums(
 ...
 enhanceAlbums(); // ✅ always run on mount and when data changes
  ...
  const valuationBtnActive = isItunes
    ...
    : isYouTube
      ? "bg-gradient-to-r from-[#CC0000] to-[#CC0000] text-white shadow-xl shadow-[#CC0000]/40 hover:shadow-[#CC0000]/70 hover:scale-105 active:scale-95"
  ...
  const valuationBorderColor = isItunes
    ...
    : isYouTube
      ? "border-[#CC0000] dark:border-[#CC0000]/70"
  ...
  const valuationBgColor = isItunes
    ...
    : isYouTube
      ? "from-[#CC0000]/10 via-[#CC0000]/5 to-[#CC0000]/10 dark:from-[#CC0000]/20 dark:via-[#CC0000]/10 dark:to-[#CC0000]/20"
  ...
  const valuationGlowRing = isItunes
    ...
    : isYouTube
      ? "ring-2 ring-[#CC0000]/40 dark:ring-[#CC0000]/40"
