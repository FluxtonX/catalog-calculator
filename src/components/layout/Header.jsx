        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className={`relative p-2.5 rounded-xl bg-gradient-to-br ${pageInfo.gradient} shadow-lg transition-all duration-300`}>
                <IconComponent size={24} className="text-white relative z-10" />
                <div className={`absolute inset-0 bg-gradient-to-br ${pageInfo.gradient} rounded-xl blur-md opacity-50`} />
              </div>
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2 transition-all duration-300">
                  {pageInfo.title}
                  {(location.pathname === "/valuation" || location.pathname === "/dashboard") && (
          ...
          <div className="hidden lg:flex flex-col items-end bg-gray-100 dark:bg-slate-800 px-4 py-2 rounded-xl border border-gray-200 dark:border-slate-700">
            <div className="text-sm font-semibold text-gray-900 dark:text-white">{formatTime()}</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">{formatDate()}</div>
          </div>
        </div>
      </div>
    </header>
