...
const ValuationTab = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      // Success message with option to view dashboard
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
        ...
        {/* ====================================
            🆕 NEW: Authentication warning banner
            ==================================== */}
        {!user && (
            ...
            <div className="flex items-start gap-4 p-5">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-700 dark:text-amber-400 mb-3">
                  You can view valuations, but you'll need to sign in to
                  download PDFs and save reports to your account.
                </p>
                <button
                  onClick={() => navigate("/auth")}
                  className="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg text-sm"
                >
                  Sign In Now
                </button>
              </div>
        ...
        <Card className="bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 shadow-xl">
          <div className="p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {/* Market Value */}
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-emerald-500/30 hover:bg-white/15 transition-all dark:bg-white/10 dark:border-emerald-500/30">
                <div className="flex flex-col items-center gap-2">
                  <div className="p-2 bg-emerald-500/20 rounded-xl">
                    <DollarSign size={20} className="text-emerald-400" />
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-gray-600 dark:text-white/70 font-semibold uppercase tracking-wide">
                      Market Value
                    </p>
                    <h3 className="text-xl font-bold text-emerald-600 dark:text-emerald-400">
                      {formatCurrency(marketValuation)}
                    </h3>
                    <p className="text-xs text-gray-500 dark:text-white/50 font-mono mt-1">
              ...
              {/* Monthly Streams */}
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-purple-500/30 hover:bg-white/15 transition-all dark:bg-white/10 dark:border-purple-500/30">
                <div className="flex flex-col items-center gap-2">
              ...
              {/* LTM Revenue */}
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-blue-500/30 hover:bg-white/15 transition-all dark:bg-white/10 dark:border-blue-500/30">
                <div className="flex flex-col items-center gap-2">
              ...
              {/* Rate */}
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-orange-500/30 hover:bg-white/15 transition-all dark:bg-white/10 dark:border-orange-500/30">
                <div className="flex flex-col items-center gap-2">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-5 border border-slate-200 dark:border-slate-700 mb-6">
              ...
              <div className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                <p>
                  ...
                  is a weighted average that measures how long your catalog's
                  earnings have been generating income.
                </p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>
                    <strong>Higher Dollar Age:</strong> Earnings from older,
                    proven tracks → More stable income
                  </li>
                  <li>
                    <strong>Lower Dollar Age:</strong> Earnings from newer
                    tracks → Growth potential but less proven
                  </li>
                </ul>
                <p className="pt-2 text-xs">
                  Formula: Σ(Track Age × Track LTM Earnings) / Total LTM
                  Earnings
                </p>
              </div>
            </div>
        ...
        <div className="flex justify-center pt-4 pb-6">
          <Button
            ...
            } text-white shadow-xl px-8 py-4 text-lg font-bold w-full sm:w-auto`}
          >
